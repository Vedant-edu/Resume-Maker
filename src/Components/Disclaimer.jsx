...
export default function Disclaimer() {
  return (
    <div className='p-4 courier-prime-regular'>
      ...
      <br />
      W.E.F : 30/03/2024 <br />
      Make My Resume is an educational platform designed to assist users in creating resumes for informational and educational purposes only. While we aim to provide helpful resources and tools, we do not guarantee job placement or success in securing employment.
      <br />
      The content provided on Make My Resume is sourced from various internet references and is intended for educational use only. We strive to ensure the accuracy and reliability of the information presented, but we cannot guarantee its completeness or suitability for individual circumstances.
      <br />
